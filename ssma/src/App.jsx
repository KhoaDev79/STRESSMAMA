    ...
    <div className="min-h-screen bg-gray-950">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400">Hệ thống quản lý bán hàng & kho</p>
              </div>
            </div>
            <button
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {currentTab === 'products' && !showForm && (
          <div>
            <h2 className="text-2xl font-bold text-white mb-6">Quản lý sản phẩm</h2>
            <ProductList
              products={products}
        ...
        {currentTab === 'analytics' && !showForm && (
          <div>
            <h2 className="text-2xl font-bold text-white mb-6">Phân tích tài chính</h2>
            <Analytics timelineData={timelineData} categoryStats={metrics.categoryStats} />
          </div>
        )}
      </main>
      ...
      <footer className="bg-gray-900 border-t border-gray-800 mt-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 text-center text-gray-500 text-sm">
          <p>© 2026 STRESSMAMA. Secondhand Fashion Management System. Powered by React + Tailwind CSS</p>
        </div>
      </footer>
    </div>
  );
